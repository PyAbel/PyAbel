...
axs[0].plot(1054, 0.6,     'H', ms=5.5, mec='k', mfc='yellow', color='k',
            label=r'Rallis $et\;al.$')
axs[1].plot(1054, 1e6/0.6, 'H', ms=5.5, mec='k', mfc='yellow', color='k',
            label=r'Rallis $et\;al.$')
axs[0].plot(1000, 0.4,     'D', ms=4, mec='k', mfc='yellow', color='k',
            label=r'Harrison $et\;al.$')
axs[1].plot(1000, 1e6/0.4, 'D', ms=4, mec='k', mfc='yellow', color='k',
            label=r'Harrison $et\;al.$')
...
leg = axs[1].legend(fontsize=8, frameon=True, loc=4, numpoints=1,

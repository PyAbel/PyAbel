...
def _find_center_by_center_of_mass(data, verbose=True, **kwargs):
...
def _find_center_by_center_of_image(data, verbose=True, **kwargs):
    return (data.shape[1]//2, data.shape[0]//2)


func_method = {
    "auto": _find_center_by_center_of_image,
    "com": _find_center_by_center_of_mass,
}

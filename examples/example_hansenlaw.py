...
#
#  O2-ANU1024.txt.bz2 is a bzipped 1024x1024 ascii velocity-map
...
reconHL, speedHL = iabel_hansenlaw (im,quad=(False,False,False,False),verbose=True,freecpus=1)
...
ax1.imshow(reconHL,aspect=None,vmin=0,vmax=reconHL[:n//2-50,:n//2-50].max())
ax1.set_ylim(ax1.get_ylim()[::-1])
ax2.plot (speedHL/max(speedHL[250:]),'b-',label='Hansen&Law')
ax2.axis(ymin=-0.5,ymax=1.5)
ax2.set_title ("ANU O2- photodetachment at 454 nm - speed")
plt.legend()
plt.savefig("example_hansenlaw_O2.png")
plt.show()
